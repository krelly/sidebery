...
async function main(): Promise<void> {
  ...
  IPC.registerActions({
    ...
    suggestTabsForGroupViaAI: Tabs.suggestTabsForGroupViaAI,
    applySuggestedTabsToGroupViaAI: Tabs.applySuggestedTabsToGroupViaAI,
    suggestGroupsForPanelViaAI: Tabs.suggestGroupsForPanelViaAI,
    createSuggestedGroupViaAI: Tabs.createSuggestedGroupViaAI,
    openTabs: Tabs.open,
